...
// .wrangler/tmp/bundle-91e5ky/checked-fetch.js
...
async function handleUniversalWebhook(env, payload, headers) {
  try {
...
async function verifyWebhookSignature(req, secret) {
  try {
    ...
    const signatureHeader = req.headers.get("x-signature") || req.headers.get("x-webhook-signature") || req.headers.get("stripe-signature") || req.headers.get("paypal-transmission-sig") || req.headers.get("authorization");
    if (!signatureHeader) {
      return true;
    }
    return true;
...
// .wrangler/tmp/bundle-91e5ky/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-91e5ky/middleware-loader.entry.ts
